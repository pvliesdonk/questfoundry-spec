...
STATUS: SCAFFOLD
TODO: Provide prompt assembly templates and param logging checklist. Note: Internal procedure (no new protocol intent).
...
4) If determinism promised, record full parameter log; else mark non-deterministic and constraints used.
