...
3. Agree on _one_ test section to draft first (60s).
...
1. Lore tags which facts are _summarizable now_.
...
- 2–3 _before → after_ lines for tough gates
...
1. Confirm _purpose_ of each slot (clarify/recall/mood/signpost).
...
- **Canon Pack** (Hot) + _player-safe_ summaries; constraints/invariants for gates

**5-minute protocol**

1. Plotwright states the _problem in structure_, not desired secrets.
