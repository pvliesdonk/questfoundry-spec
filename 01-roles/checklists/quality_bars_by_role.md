...
- **Primary bars** = the ones you’re expected to _move_ for your slice.
...
- TU is _small_ and roles awakened match the slice.
- Cold snapshot/View identified; _no_ Hot in exports.
