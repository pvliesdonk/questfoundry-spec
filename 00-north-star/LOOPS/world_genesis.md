...
- At project start, **before** first Story Spark.
...
- **Research constraints** (if Researcher active: real-world inspirations to corroborate).
...
- **Lore Weaver (R)**
  - **Proactive canon creation** (not reactive to hooks).
  - Draft canon packs for each scoped theme:
    - Geography (regions, landmarks, trade routes)
    - Magic/Metaphysics (rules, constraints, sources)
    - History (timeline, wars, dynasties)
    - Factions (houses, guilds, temples, structure)
    - Culture (customs, technology, language notes)
  - Define invariants & constraints for each theme.
  - Build timeline foundation (T0 = ancient past, T1 = recent history, T2 = story "now").
  - Create knowledge ledger (who knows what about the world).
- **Codex Curator (C)**
  - Create player-safe codex baseline for world elements:
    - Geography entries (kingdoms, landmarks)
    - Magic/Faction entries (schools, houses)
    - Historical entries (wars, dynasties)
  - Build taxonomy (category structure for codex).
  - Cross-link entries.
- **Researcher (C, optional)**
  - If active: corroborate real-world inspirations (e.g., medieval siege tactics, trade routes).
  - Attach citations to factual canon.
  - If dormant: mark `uncorroborated:<risk>`.
- **Style Lead (C)**
  - Define world voice/register:
    - Narrative voice (formal? colloquial? archaic?)
    - Dialogue patterns (nobility vs. commoners)
...
- **Showrunner (A)**
  - Scopes worldbuilding themes and budget.
  - Triggers loop iteration if Gatekeeper blocks.
  - Approves merge to Cold after stabilization.

---

## 4) Procedure

### 4.1 Frame the World (Lore Weaver + Showrunner)

Define worldbuilding scope and budget:
...
- How many major factions (houses, guilds, empires)?
- Cultural detail (customs, language, technology level)?

**Output:** Worldbuilding scope document listing themes to cover.

---

### 4.2 Proactive Canon Creation (Lore Weaver)

For each scoped theme, Lore Weaver drafts canon packs **proactively** (no hooks required):
...
- **Entity/State Deltas** — Regional boundaries over time.
- **Knowledge Ledger** — Who knows secret routes, hidden landmarks.
- **Player-Safe Summaries (Cold)** — "The Ironwood Forest spans 200 leagues..."
...
- **Knowledge Ledger** — Who knows advanced techniques, forbidden spells.
- **Player-Safe Summaries (Cold)** — "Mages draw power from ley lines..."
...
- **Entity/State Deltas** — How kingdoms rose/fell.
- **Player-Safe Summaries (Cold)** — "The Three Kingdoms War reshaped borders in Y-150..."
...
### 4.4 Codex Baseline (Codex Curator)
...
**Style addendum:** Created for Scene Smith to use during Story Spark.
...
**Example iteration (see §11):**

---

## 5) Deliverables (Hot → Cold after gatecheck)

- **Canon Packs** (one per theme: geography, magic, history, factions, culture)
  - Status: `cold-merged` (immutable baseline for story)
...
- **Constraint Manifest** (rules for Plotwright)
  ...
  - "House Vaelen controls northern trade routes."
  - "The Ironwood Forest is impassable in winter."
- **Entity Registry** (characters, places, factions defined in genesis)
- **TU** (`TU-<date>-LW-WorldGenesis`)
...
- All scoped worldbuilding themes have canon packs.
- No internal contradictions in genesis canon.
- Codex baseline covers world fundamentals.
- Style addendum sets voice/register.
- Timeline foundation (T0/T1/T2) is clear.
- Constraint manifest is actionable for Plotwright.
- Gatekeeper approves (Integrity + Style + Presentation).
- Story Spark can design topology using genesis canon.
...
- **To Story Spark**: Constraint manifest, timeline foundation, entity registry, style addendum.
- **To Lore Deepening**: Hooks from Story Spark can **extend** genesis canon (not contradict).
- **To Codex Expansion**: Gap list (plot-specific entries needed after Story Spark).

---

## 11) Example (miniature with iteration)
...
- Factions: 8 great houses, 3 temples, 2 guilds
- Metaphysics: Gods, afterlife, prophecy mechanics, soul magic
- Culture: Nobility etiquette, commoner dialects, religious customs
...
Iteration 1:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✓ Step 1: Frame the World (scope: magic, geography, factions, history)
✓ Step 2: Draft Geography Canon (Lore Weaver)
     - 12 kingdoms, 3 continents, ley line map
✓ Step 3: Draft Magic Canon (Lore Weaver)
     - 5 schools, ley line mechanics, divine vs. arcane
✓ Step 4: Draft History Canon (Lore Weaver)
     - 500-year timeline, 3 wars, 8 dynasties
✓ Step 5: Draft Faction Canon (Lore Weaver)
     - 8 houses, 3 temples, 2 guilds
✓ Step 6: Draft Metaphysics Canon (Lore Weaver)
     - Gods, afterlife, prophecy, soul magic
✓ Step 7: Codex Baseline (Codex Curator)
     - 100+ entries (kingdoms, magic, gods, wars)
✓ Step 8: Style Anchors (Style Lead)
     - Formal narrative, noble/commoner dialogue patterns
⟳ Step 9: Gatekeeper Preview...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
❌ Gatekeeper found issues
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Issues:
  - Geography canon: Ley lines don't align with kingdom borders (contradicts magic canon)
  - History canon: War dates conflict with dynasty timeline
  - Faction canon: House Vaelen controls "northern routes" but geography canon doesn't define them

Showrunner decision: Revise geography and history (back to Step 2)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
Iteration 2:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⟳ Step 2: Revise Geography Canon (Lore Weaver)
     - Align ley lines with kingdom borders
     - Define northern trade routes explicitly
✓ Step 2: Geography revised
⟳ Step 4: Revise History Canon (Lore Weaver)
     - Fix war/dynasty timeline conflicts
✓ Step 4: History revised
✓ Step 3: Magic Canon (no changes needed, ley lines now aligned)
✓ Step 5: Faction Canon (no changes needed, northern routes now defined)
✓ Step 6: Metaphysics Canon (no changes needed)
✓ Step 7: Update Codex (revised geography/history entries)
✓ Step 8: Style check (passed)
✓ Step 9: Gatekeeper Preview (PASSED)
✓ Step 10: Merge to Cold
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
✅ Loop Stabilized
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Duration: 22h 15m (2 iterations)
TU: TU-2025-11-10-LW-WorldGenesis

Artifacts Created:
  ✓ Geography Canon (12 kingdoms, ley line network, trade routes)
  ✓ Magic Canon (5 schools, ley mechanics, divine/arcane split)
  ✓ History Canon (500-year timeline, 3 wars, 8 dynasties)
  ✓ Faction Canon (8 houses, 3 temples, 2 guilds)
  ✓ Metaphysics Canon (gods, afterlife, prophecy, soul magic)
  ✓ Codex Baseline (100+ entries)
  ✓ Style Addendum (formal narrative, noble/commoner patterns)
  ✓ Timeline Foundation (T0-T2)
  ✓ Constraint Manifest (25 invariants for Plotwright)

Next suggested loop: Story Spark
```
...
- The Blood Compact of Y-300 binds all signatories; breaking triggers war.
...
- 2 guilds (trade, neutrality)
- 5 magic schools (rules, practitioners)
