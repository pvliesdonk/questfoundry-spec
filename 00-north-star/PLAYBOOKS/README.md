...
|                                                     |                                       |                                                                    |
| **Canon-Centric Workflows**                         |                                       |                                                                    |
| Build detailed worldbuilding before plot design     | `playbook_world_genesis.md`           | Canon packs + codex baseline + style anchors + constraint manifest |
| Export canon from completed project for reuse       | `playbook_canon_transfer_export.md`   | Canon Transfer Package with invariant/mutable canon + timeline     |
| Import canon from prior project to seed new story   | `playbook_canon_transfer_import.md`   | Seeded Hot/Cold with imported canon + constraint documentation     |
...
**Canon-Centric Workflows:**
- `playbook_world_genesis.md`
- `playbook_canon_transfer_export.md`
- `playbook_canon_transfer_import.md`
