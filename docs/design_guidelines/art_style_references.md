...
Each genre has visual guidance including:

- **Color Palette** - Recommended colors and moods
- **Composition** - Camera angles, framing, layout
- **Lighting & Atmosphere** - Mood-setting techniques
- **Reference Artists** - Visual inspiration (historical and contemporary)
- **Prompt Template Fragments** - Reusable text for AI image generation or artist briefs

**For prompts:** Use these as reference when creating shotlists or artist briefs.

**For Art Director:** Reference when building art_manifest and coordinating with artists/AI tools.
...
- **Frequency:** 1 per chapter or 1 per 10-15 sections (varies by budget)
...
Lighting: single dramatic light source, venetian blind shadows, chiaroscuro
Mood: tense, morally ambiguous, atmospheric, gritty noir, urban decay
Composition: low angle, Dutch angle, tight framing, negative space dominated by shadows
```
...
Color: rich jewel tones, emerald and gold, vibrant fantasy palette
Lighting: golden hour, dramatic sunset, torch-lit, magical illumination
Mood: epic, heroic, adventurous, awe-inspiring
Composition: wide angle, hero shot from below, vast landscapes

Dark Fantasy:
Atmosphere: gothic architecture, desolate wastelands, cursed forests, ominous skies
Color: desaturated, black and burgundy, sickly greens, tarnished metal
Lighting: dim, shadowy, unnatural glows, stormy overcast
Mood: grim, foreboding, dark, oppressive
Composition: low angle, looming threats, claustrophobic ruins
```
...
Color: desaturated, sepia tones, deep reds and blacks
Lighting: flickering candlelight, long shadows, dim and oppressive
Mood: dread, gothic, atmospheric horror, isolation
Composition: off-kilter angles, tight framing, shadows obscuring threats

Modern Horror:
Atmosphere: sterile hospital corridors, concrete brutalist architecture, empty parking structures
Color: clinical whites and grays, harsh fluorescent lighting, blood red accents
Lighting: harsh overhead lights, deep shadows in corners, backlit silhouettes
Mood: unsettling, clinical, psychological horror
Composition: symmetrical (unsettling perfection), extreme close-ups, empty space

Cosmic Horror:
Atmosphere: alien geometries, impossible architecture, void of space, tentacled monstrosities
Color: unnatural purples and greens, bioluminescent glows, void blacks
Lighting: otherworldly, non-directional, emanating from unknowable sources
Mood: existential dread, incomprehensible, Lovecraftian
Composition: scale contrast (tiny humans vs. cosmic entities), distorted perspectives
```
...
Color: sepia and burgundy, dark wood interiors, gaslight amber
Lighting: gaslight, firelight, dramatic but not as harsh as noir
Mood: methodical, intellectual, period atmosphere
Composition: balanced, focused on details and clues

Golden Age Mystery:
Atmosphere: art deco interiors, 1920s-30s glamour, country manor houses
Color: period-appropriate pastels and jewel tones, art deco palettes
Lighting: elegant interior lighting, natural daylight
Mood: sophisticated, puzzle-like, nostalgic
Composition: symmetrical, organized, clear visual hierarchy

Modern Mystery:
Atmosphere: contemporary urban settings, police stations, forensic labs
Color: cool blues and grays, realistic and understated
Lighting: fluorescent, natural daylight, investigative realism
Mood: procedural, methodical, contemporary
Composition: documentary-style, focused on evidence
```
...
Color: soft pastels, blush pink and cream, warm and inviting
Lighting: golden hour, soft window light, warm and flattering
Mood: tender, heartwarming, optimistic, gentle
Composition: close-up on characters' connection, soft bokeh backgrounds

Steamy Romance:
Atmosphere: intimate settings, elegant bedrooms, dramatic romantic destinations
Color: rich jewel tones, burgundy and gold, deep and sensual
Lighting: dramatic but soft, candlelight, sunset, bedroom lighting
Mood: passionate, intense, sensual, emotionally charged
Composition: close intimate framing, emphasis on touch and proximity

Contemporary Romance:
Atmosphere: modern urban settings, trendy cafes, city skylines, contemporary interiors
Color: bright modern palettes, coral and teal, millennial pink
Lighting: natural bright light, clean and fresh
Mood: fun, optimistic, relatable, modern
Composition: candid moments, lifestyle photography aesthetic
```
...
Color: hot pink and cyan neon, purple and green accents, dark backgrounds
Lighting: neon reflections, harsh artificial light, holographic glows
Mood: dystopian, high-tech low-life, urban decay meets futurism
Composition: layered depth, wide cinematic shots, contrast between tech and decay

Space Opera:
Atmosphere: starship interiors, alien planets, space stations, nebulae backgrounds
Color: deep space blues and blacks, starlight whites, alien world colors
Lighting: dramatic space lighting, harsh shadows, glowing control panels
Mood: epic, adventurous, optimistic or ominous (depends on tone)
Composition: wide shots showing scale, hero shots of ships, alien vistas

Hard Sci-Fi:
Atmosphere: realistic space stations, research facilities, near-future technology
Color: whites, grays, blacks, metallic accents
Lighting: clinical fluorescent, screen glows, realistic space lighting
Mood: grounded, scientific, plausible, technical
Composition: functional and realistic, documentary-style
```
...
When using AI tools (Midjourney, DALL-E, Stable Diffusion):

### Prompt Structure

1. **Subject:** What is the main focus? (character, scene, object)
2. **Style:** Art style reference (e.g., "film noir style," "art deco poster")
3. **Mood:** Emotional tone (e.g., "atmospheric," "tense," "romantic")
4. **Lighting:** Specific lighting (e.g., "dramatic shadows," "golden hour")
5. **Color:** Color palette (e.g., "black and white with amber accents")
6. **Composition:** Camera angle, framing (e.g., "low angle," "wide shot")
...
7. **Text Space:** If cover, where will title/author name appear? (Artist should leave space)
...
- **Portfolio Use:** Can artist display work in their portfolio?
...
Examples:
midnight-deposition_cover_01_final.png
midnight-deposition_interior_01_alley-scene.png
midnight-deposition_thumbnail_01_square.png
```
